    ...
    <>
      <div className="md:flex hidden flex-col w-[240px] py-10 px-4 bg-[#000000]">
        <img
          src={spotify}
          alt="Spotify Logo"
          className="w-full h-15 ml-7 object-contain"
        />
        <NavLinks />
      </div>
      ...
      <div
        className={`absolute top-0 h-screen w-2/3 bg-gradient-to-t1 from-white/10 to-[#157c39] backdrop-blur-lg z-10 p-6 md:hidden smooth-transition ${
